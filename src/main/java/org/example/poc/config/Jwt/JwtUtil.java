...
public class JwtUtil {
    ...
    public JwtUtil(@Value("${SECURITY_JWT_SECRET:abc123456789abc123456789abc12345}") String secret,
                   @Value("${SECURITY_JWT_EXPIRATION_MILLIS:7200000}") long expirationTime) {
